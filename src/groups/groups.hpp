...
class RecipientGroupNotFoundException : public std::exception {
 private:
  const std::string FORMAT{"Group does not exist group_id={}"};
...
class RecipientAlreadyAddedException : public std::exception {
 private:
  const std::string FORMAT{"Recipient already added to the group recipient_id={}, group_id={}"};
  const std::string _msg;
 public:
...
class RecipientNotAddedException : public std::exception {
 private:
  const std::string FORMAT{"Recipient not added to the group recipient_id={}, group_id={}"};
  const std::string _msg;
 public:
